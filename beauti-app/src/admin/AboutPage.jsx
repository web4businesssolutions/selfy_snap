...
const AdminAbout = () => {
  ...
  const fetchAbout = async () => {
    try {
      setLoading(true);
      const res = await axios.get("https://selfy-snap-1-7kn9.onrender.com/api/about/all");
      ...
      if (data.image) {
        setImagePreview(`https://selfy-snap-1-7kn9.onrender.com${data.image}`);
      }
    } catch (err) {
      console.error(err);
  ...
  const handleUpdate = async (field) => {
    try {
      ...
      await axios.put(`https://selfy-snap-1-7kn9.onrender.com/api/about/update/${aboutId}`, {
        [field]: value,
      });
  ...
  const handleImageUpload = async () => {
    ...
    try {
      await axios.put(
        `https://selfy-snap-1-7kn9.onrender.com/api/about/update/${aboutId}`,
        formData,
