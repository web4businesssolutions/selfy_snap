...
const AdminFooter = () => {
  ...
  useEffect(() => {
    axios.get("https://selfy-snap-1-7kn9.onrender.com/api/footer/all").then(res => {
      setFooter(res.data);
  ...
  const handleSubmit = async () => {
    ...
    if (footer?._id) {
      await axios.put(`https://selfy-snap-1-7kn9.onrender.com/api/footer/update/${footer._id}`, form);
    } else {
      await axios.post("https://selfy-snap-1-7kn9.onrender.com/api/footer/add", form);
    }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto bg-white rounded shadow">
      ...
      <div className="mb-6">
        ...
        {footer?.logoUrl && <img src={`https://selfy-snap-1-7kn9.onrender.com/${footer.logoUrl}`} className="w-24 mt-2 rounded shadow" />}
      </div>
