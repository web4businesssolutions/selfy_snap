...
const Category = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editMode) {
                await axios.put(
                    `https://selfy-snap-1-7kn9.onrender.com/api/categories/update/${editId}`,
                    formData,
                    { headers: { "Content-Type": "multipart/form-data" } }
                );
            } else {
                await axios.post(
                    "https://selfy-snap-1-7kn9.onrender.com/api/categories/create",
                    formData,
                    { headers: { "Content-Type": "multipart/form-data" } }
                );
            }
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Are you sure you want to delete this category?")) {
            try {
                await axios.delete(`https://selfy-snap-1-7kn9.onrender.com/api/categories/delete/${id}`);
                fetchCategories();
            } catch (error) {
