...
const AdminTerms = () => {
  ...
  const fetchTerms = async () => {
    const res = await axios.get("https://selfy-snap-1-7kn9.onrender.com/api/terms/all");
    setTerms(res.data);
  };
  ...
  const handleSubmit = async () => {
    for (const sec of sections) {
      if (sec.heading) {
        await axios.post("https://selfy-snap-1-7kn9.onrender.com/api/terms/add", {
          heading: sec.heading,
          content: sec.content,
  ...
  const handleUpdate = async () => {
    ...
    await axios.put(`https://selfy-snap-1-7kn9.onrender.com/api/terms/update/${section.id}`, {
  ...
  const handleDelete = async (id) => {
    await axios.delete(`https://selfy-snap-1-7kn9.onrender.com/api/terms/delete/${id}`);
    fetchTerms();
  };
